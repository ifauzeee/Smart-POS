...
 * @desc    Mendapatkan daftar semua pelanggan dengan opsi pencarian yang aman.
...
            // FIXED: Menggunakan parameterized query untuk mencegah SQL Injection.
            // Input dari pengguna (search) diperlakukan sebagai data, bukan sebagai bagian dari perintah SQL.
...
        // Mengunci baris pelanggan untuk menghindari race condition saat update poin
...
        // Menghitung ulang total poin dari log untuk memastikan konsistensi
...
            customer.points = correctTotalPoints; // Perbarui objek customer agar data yang dikembalikan sinkron
        }
...
    const businessId = req.user.business_id;
    try {
        // Menggunakan UNION ALL untuk menggabungkan riwayat transaksi dan penukaran poin
        const query = `
            SELECT 
...
        
        // Menghitung nilai rata-rata order
...
 * @desc    Menukarkan poin pelanggan (manual).
 * @access  Private
 */
...
/**
 * @route   POST /api/customers/:id/redeem-reward
 * @desc    Menukarkan poin pelanggan dengan hadiah dari katalog.
 * @access  Private
 */
